...
public class FXMLEncryptionController implements Initializable {
    ...
    // File dat vercijferd moet worden
    // Bevat de salt, het vercijferde bericht
    private File file;
    ...
    public void cryptAction(ActionEvent event) throws NoSuchAlgorithmException, InvalidKeySpecException, InvalidAlgorithmParameterException {
        ...
        if (checkBoxEncrypt.isSelected()) {
            ...
            throw new IllegalArgumentException("Select a checkbox option. Don't have both selected!");
        }
    }
    /*
     Verder wordt bij vercijfering een filenaam gekozen voor de output. De outputfile bevat de salt, gevolgd door de vercijferde boodschap.
     */
    ...
    private void encrypt(String message) throws NoSuchAlgorithmException, InvalidKeySpecException, InvalidAlgorithmParameterException {
        ...
        //PBEKeySpec pbeKeySpec = new PBEKeySpec(passwordInput.toCharArray(), pbeParameterSpec.getSalt(), count, saltBytes.length);
    ...
    private String readFromFile() {
        try {
            ...
            taMessage.setText("Encrypted message: \n\n" + textEncrypted);
    ...
    private void clearPassword(String pass) {
        ...
        tfPassword.setText(password.toString());
    }

    /**
     * Disables all UI Functions.
     */
